...
import template from './bericht-vertrag-mit-kosten.template.html';

/* eslint-disable no-param-reassign */

class BerichtVertragMitKostenCtrl {
  ...
  getData(params) {
    ...
    return this.ImportExport.kosten().$promise
  ...
  export() {
    const sheetName = 'Vertragsdaten-mit-Kosten';
    const filename = `Vertragsdaten-mit-Kosten-${moment().format('YYYY-MM-DD')}.xlsx`;
...
angular.module('berichtVertragMitKosten')
  .component('berichtVertragMitKosten', {
    template,
    controller: BerichtVertragMitKostenCtrl,
  });
