...
import template from './contract-view-document-tab.template.html';
...
class ContractViewDocumentTabCtrl {
...
angular.module('contractViewDocumentTab')
  .component('contractViewDocumentTab', {
    template,
    bindings: {
      vertrag: '=',
      type: '<',
    },
    controller: ContractViewDocumentTabCtrl,
  });
