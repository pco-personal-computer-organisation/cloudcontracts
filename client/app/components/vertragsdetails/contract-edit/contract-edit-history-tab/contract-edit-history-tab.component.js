...
import template from './contract-edit-history-tab.template.html';

class ContractEditHistoryTabCtrl {
  constructor(NgTableParams, Historie) { // eslint-disable-line max-len
...
angular.module('contractEditHistoryTab')

.component('contractEditHistoryTab', {
  template,
  bindings: {
    vertrag: '=',
  },
  controller: ContractEditHistoryTabCtrl,
});
